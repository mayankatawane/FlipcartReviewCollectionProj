...
from webdriver_manager.chrome import ChromeDriverManager3
...
class threadClass:
    ...
    def run(self):
        ...
        collection_name = self.scrapper_object.getReviewsToDisplay(expected_review=self.expected_review,
                                                                   searchString=self.searchString, username='Mayanknew',
                                                                   password='12345',
...
def index():
    if request.method == 'POST':
        ...
        try:
            ...
            mongoClient = MongoDBManagement(username='Mayanknew', password='12345')
