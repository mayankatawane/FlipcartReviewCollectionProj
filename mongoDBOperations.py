...
class MongoDBManagement:
    ...
    def __init__(self, username, password):
        ...
        try:
            ...
            self.url = "mongodb+srv://{}:{}@cluster0.ndffr.mongodb.net/myFirstDatabase?retryWrites=true&w=majority".format(self.username, self.password)
    ...
    def getMongoDBClientObject(self):
        ...
        """
        try:
            mongo_client = pymongo.MongoClient(self.url,ssl_cert_reqs = ssl.CERT_NONE)
            return mongo_client
        except Exception as e:
